...
export class AuthService {
  ...
  static async loginWithGoogle(credential: string): Promise<string> {
  ...
  private static async verifyGoogleToken(idToken: string): Promise<Required<Pick<GoogleTokenInfo, "sub" | "email">> & GoogleTokenInfo> {
    try {
